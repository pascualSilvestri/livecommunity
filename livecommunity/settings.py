...
MIDDLEWARE = [
    ...
    "django.contrib.sessions.middleware.SessionMiddleware",  # Después de SessionMiddleware
    "corsheaders.middleware.CorsMiddleware",  # Coloca CorsMiddleware aquí
...
EMAIL_HOST_PASSWORD = 'hehq iudi huws acsg'
