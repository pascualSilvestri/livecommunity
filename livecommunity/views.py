...
def home_pk(request, pk):
    ...
    if afiliado:
        url_video_insercion =  convertir_url_youtube(afiliado.url_video) if afiliado.url_video !="" or afiliado.url_video == "0" else "https://www.youtube.com/watch?v=HgKjhFEguyU"
